<p align="center">
 <img alt="" src="/_icons/logoColor.png" width=500 align="center">
</p>

FreeTube Focus is an open source desktop YouTube player built with privacy and education in mind.
Use YouTube without advertisements and prevent Google from tracking you with their cookies and JavaScript.
This version constitutes a specialized educational build that filters content to ensure a distraction-free learning environment.
Available for Windows (10 and later), Mac (macOS 12 and later) & Linux thanks to Electron.

<p align="center"><a href="https://github.com/FreeTubeApp/FreeTube/releases">Download FreeTube Focus</a></p>
<p align="center">
...
> [!IMPORTANT]  
> Using a VPN or Tor is highly recommended to hide your IP while using FreeTube Focus.
...
* SponsorBlock
* DeArrow
* Open videos from your browser directly into FreeTube Focus (with extension)
...
* Show/hide functionality or elements within the app using the distraction free settings
* View channel posts
* **Educational Mode**: Automatically restricts searches and feeds to educational content
* **Perplexity AI Integration**: Generate deep study notes and summaries for videos using Perplexity AI
* **Material Design 3 UI**: Modern user interface updated to follow Material Design 3 guidelines

### Browser Extensions
The following extensions open YouTube links directly in FreeTube Focus:

- [LibRedirect](https://libredirect.github.io/)
- [RedirectTube](https://github.com/MStankiewiczOfficial/RedirectTube)

LibRedirect automatically redirect YouTube links to FreeTube Focus.
> [!IMPORTANT]
> To ensure proper functionality, select FreeTube as Frontend in the Services settings of the extension.

RedirectTube, doesn’t automatically open YouTube links in FreeTube Focus. Instead, it adds buttons to the toolbar and context menu, which you can click to open videos in FreeTube Focus manually.
...
> [!CAUTION]
> FreeTube Focus is only supported on Windows 10 and later, macOS 12 and above, and various Linux distributions. Installing it on unsupported systems may result in unexpected issues.
...
## Donate
If you enjoy using FreeTube Focus, you're welcome to leave a donation using the following method.  
...
FreeTube Focus is Free Software: You can use, study share and improve it at your
